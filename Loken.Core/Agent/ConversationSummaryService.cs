...
""";
        ...
        var summary = string.Join("", response.Value.Content.Select(c => c.Text));
        ...
        sb.AppendLine("---");
        sb.AppendLine();
        sb.AppendLine("_Summary generated by AI._");
...
""";
        ...
        var title = string.Join("", response.Value.Content.Select(c => c.Text)).Trim();
    ...
    private static string SanitizeFileName(string title)
    {
        ...
        var sanitized = new string(title.Where(c => !invalid.Contains(c) && !char.IsControl(c)).ToArray());
